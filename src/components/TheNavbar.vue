<template>
    <nav class="navbar sticky-top navbar-expand-md bg-dark">
        <div class="container-fluid">
            <RouterLink class="navbar-brand fs-1 m-0" to="/"><span class="align-middle text-light">My best
                    recipes</span>
            </RouterLink>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mb-2 mb-lg-0 d-flex justify-content-end" style="width: 100%">
                    <li class="nav-item me-5 fs-5">
                        <RouterLink class="nav-link" to="/"><span class="align-middle text-light">Recipes</span>
                        </RouterLink>
                    </li>
